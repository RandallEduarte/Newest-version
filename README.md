...
<body>
  ...
  </header>  <!-- Company Modal (selection only, creation disabled) -->  <div id="companyModal" class="hide" style="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.5);z-index:60">
    <div class="card section" style="width:min(520px,92vw)">
